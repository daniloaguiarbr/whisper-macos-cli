...
Dual-licenciado sob qualquer uma:

- Apache License, Version 2.0 — veja [LICENSE-APACHE](LICENSE-APACHE)
- MIT License — veja [LICENSE-MIT](LICENSE-MIT)

à sua escolha. Avisos de terceiros em [NOTICE](NOTICE) e via
